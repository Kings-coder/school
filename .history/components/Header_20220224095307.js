...
function Header() {
    return( 
        <div className="sticky bg-[# <Link href="/">
        <a className="text-black text-lg font-bold">School of Science and Technology
            </a></Link>] top-0 z-[1000] flex items-center px-10 h-[72px] md:px-12 justify-center">
           ...
           <a className="header-link group">
               ...
               <a className="header-link group">
                   <HomeIcon className="h-4 "/><span className="span">Department</span>
               </a>
               <a className="header-link group">
